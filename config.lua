...
config.chatWindowInstructions = color.Yellow .. "Y" .. color.White .. " to chat.\nClient crashes sometimes for different reasons. Relog if happens. Maybe /oops if something else happens.\n"
