...
testDMMaps.fort = {}
testDMMaps.fort.usedCells = {"-6, -1"}
testDMMaps.fort.teamSpawnLocations = {}



testDMMaps.fort.teamSpawnLocations[1] = {
	{"-6, -1", -43889, -3840, 1665, -1}, 
	{"-6, -1", -45135, -5017, 1665, 0}, 
	{"-6, -1", -46295, -3724, 1665, 1}, 
	{"-6, -1", -45032, -2602, 1665, -3},

	--{"Arkngthand, Deep Ore Passage", 1611.546, 14640.565, 38.920, 0},
	--{"Arkngthand, Deep Ore Passage", 1608.487, 17542.883, 39.018, 0},
	--{"Arkngthand, Deep Ore Passage", 2985.154, 16149.599, 38.967, 0},
	--{"Arkngthand, Deep Ore Passage", 116.321, 16155.957, 41.811, 0},

--[[	{"Vivec, Foreign Quarter Underworks", 1867.0607910156, 274.11645507813, 14.828719139099, -1}, 
	{"Vivec, Foreign Quarter Underworks", 6129.5512695313, 232.7096862793, 14.933967590332, 0}, 
	{"Vivec, Foreign Quarter Underworks", 1867.0607910156, 274.11645507813, 14.828719139099, -1}, 
	{"Vivec, Foreign Quarter Underworks", 6129.5512695313, 232.7096862793, 14.933967590332, 0},  ]]

--	{"Arkngthand, Weepingbell Hall", 7424, 3648, 13761, -1}, 
--	{"Mzahnch", 3156, 21, -127, 0}, 
--	{"Galom Daeus, Entry", -784, 5500, 12225, 1}, 
--	{"Dagoth Ur, Outer Facility", 20, -161, -575, -2}, 
	--{"-3, -2", -23094, -13937, 872, 2.42}, 
	--{"-3, -2", -24040, -16020, 505, 1.30}, 
	--{"-3, -2", -23216, -16223, 505, 0.60}
}

testDMMaps.fort.teamSpawnLocations[2] = {
	{"-6, -1", -43889, -3840, 1665, -1}, 
	{"-6, -1", -45135, -5017, 1665, 0}, 
	{"-6, -1", -46295, -3724, 1665, 1}, 
	{"-6, -1", -45032, -2602, 1665, -3}, 
...
testDMMaps.cave = {}
testDMMaps.cave.usedCells = {"Arkngthand, Deep Ore Passage"}
testDMMaps.cave.teamSpawnLocations = {}

testDMMaps.cave.teamSpawnLocations[1] = {
...
testDMMaps.cave.teamSpawnLocations[2] = {
...
testDMMaps.juno = {}
testDMMaps.juno.usedCells = {"Urshilaku, Juno Burial"}
testDMMaps.juno.teamSpawnLocations = {}

testDMMaps.juno.teamSpawnLocations[1] = {
...
testDMMaps.juno.teamSpawnLocations[2] = {
	{"Urshilaku, Juno Burial", 3348.2534179688, 5174.0263671875, 12481, 2.6229231357574}, 
	{"Urshilaku, Juno Burial", 4047.6484375, 5912.8486328125, 12481, 0.79870438575745}, 
	{"Urshilaku, Juno Burial", 4383.0712890625, 7384.4404296875, 12438.924804688, 3.1346418857574}, 
	{"Urshilaku, Juno Burial", 4671.6176757813, 5371.5971679688, 12482.970703125, -1.1817643642426}, 
